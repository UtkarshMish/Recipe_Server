...
class Recommender:
	...
	def __init__(self, cuisine_list, query):
		...
		self.label = TfidfVectorizer(decode_error="replace", stop_words='english', lowercase=True, analyzer="word")
	...
	def guide_predictor(self):
		...
		cosine_similarities = cosine_similarity(search_query, self.matrix).flatten()
